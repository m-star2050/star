...
<div x-data="{open:true, showUpload:false, showDelete:false, showPreview:false, deleteId:null, previewUrl:'', previewType:''}" class="relative">
    <aside class="fixed top-3 left-3 h-[calc(100vh-24px)] glass rounded-2xl p-3 transition-all duration-300" :class="open ? 'w-64' : 'w-16'">
        ...
        <nav class="space-y-1 mt-4">
            ...
            <a href="{{ route('crm.files.index') }}" class="sidebar-link bg-white/20">
    ...
    <div class="transition-all duration-300 pb-8" :class="open ? 'ml-72' : 'ml-24'">
        <div class="mr-6 mt-6">
            ...
            <div class="glass rounded-xl p-4 mb-4">
                <form method="GET" action="{{ route('crm.files.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('crm.files.index') }}" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg font-semibold">Reset</a>
                    </div>
                </form>
            </div>

            <!-- Files Grid -->
            <form method="POST" action="{{ route('crm.files.bulk-delete') }}" x-ref="bulkForm">
                @csrf
                ...
                <!-- Pagination -->
                <div class="flex flex-col md:flex-row items-center md:justify-between gap-3 p-3 mt-4">
                    ...
                    <form method="GET" class="flex items-center gap-2">
                        ...
                        <a href="{{ route('crm.files.index') }}" class="px-4 py-2 rounded-xl border bg-gray-100 hover:bg-gray-200 text-gray-600 ml-2">Reset</a>
                    </form>
                </div>
